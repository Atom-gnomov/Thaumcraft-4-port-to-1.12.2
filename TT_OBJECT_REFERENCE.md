...
> в `../tc4/tt-original-1.7.10`). Ничего здесь не придумано и не пересчитано.
...
2. **Если объекта здесь нет — открой оригинал**, а не придумывай по аналогии.
   Локальная копия исходников лежит в `../tc4/tt-original-1.7.10`
   (относительно корня репозитория — работа идёт с нескольких машин,
   абсолютные пути не писать).
