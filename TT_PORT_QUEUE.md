...
>
> Перегенерировать можно: `scripts/gen_tt_queue.py` читает
> `../tt-original-1.7.10`, а клон оригинала живёт в
> `../tc4/tt-original-1.7.10` — скрипту нужен путь, клон на машине есть.
> Открытые расхождения модуля живут в [`KNOWN_ISSUES.md`](KNOWN_ISSUES.md) и
