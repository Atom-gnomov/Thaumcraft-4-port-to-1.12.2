...
**Что в работе сейчас:** свободен. Свободные объекты закрыты в 1.1.23.0;
остались девять KAMI, и разбор оригинала под них уже лежит в
[`TT_KAMI_HANDOFF.md`](TT_KAMI_HANDOFF.md) — начинать оттуда, а не с чтения
исходников заново. Порядок: портал → жемчужина → фокус отзыва, потом меч и
два оставшихся фокуса.

**Состояние модуля:** 70 из 79 достижимых объектов, версия 1.1.23.0.
