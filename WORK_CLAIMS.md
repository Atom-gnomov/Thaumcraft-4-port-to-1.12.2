...
**Что в работе сейчас:** ихоровая броня. Базовые четыре части в 1.1.14.0;
дальше пробуждённые (gem) версии.

**Состояние модуля:** 50 из 84 объектов каталога, версия 1.1.14.0.
