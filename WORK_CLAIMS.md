...
**Что в работе сейчас:** свободные предметы из очереди. В 1.1.21.0 —
некромантия; осталось из свободных: том обмена, письменные принадлежности,
левитатор с реле.

**Состояние модуля:** 66 из 79 достижимых объектов, версия 1.1.21.0.
