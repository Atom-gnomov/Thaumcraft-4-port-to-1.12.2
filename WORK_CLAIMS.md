...
**Что в работе сейчас:** свободен. Пробуждённая броня в 1.1.16.0, три части из
четырёх; шаровары ждут газовых блоков.

**Состояние модуля:** 54 из 84 объектов каталога, версия 1.1.16.0.
