...
**Что в работе сейчас:** свободные предметы из очереди. В 1.1.20.0 — цепочка
наполненных посевов; осталось из свободных: дощечка некромантии, проклятое
лезвие, том обмена, письменные принадлежности, аспект души, левитатор с реле.

**Состояние модуля:** 63 из 79 достижимых объектов, версия 1.1.20.0.
