...
**Что в работе сейчас:** свободен. В 1.1.10.0 закрыт последний кусок долга из
аудита — тринадцать рецептов блоков переписаны с оригинала. Следующее беру из
`TT_PORT_QUEUE.md`.

**Состояние модуля:** 47 из 84 объектов каталога, версия 1.1.10.0.
