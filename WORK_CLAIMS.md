...
**Что в работе сейчас:** свободные предметы из очереди. В 1.1.19.0 — зелья и
силовое поле; дальше остальные из списка «свободно», потом KAMI, потом
заблокированные.

**Состояние модуля:** 59 из 79 достижимых объектов, версия 1.1.19.0.
