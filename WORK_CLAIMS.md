...
**Читать первым:** аудит 2026-07-28 нашёл, что 55 из 62 рецептов модуля
привязаны к исследованиям, которых в порту нет, и поэтому не сработают в
игре вовсе. См. `KNOWN_ISSUES.md`, первый пункт. Ветка исследований TT —
теперь не «последняя большая система», а то, без чего модуля фактически нет.
Брать её раньше оставшихся девяти объектов KAMI.

**Состояние модуля:** 70 из 79 объектов перенесены, версия 1.1.23.0.
