...
**Что в работе сейчас:** свободен. Камуфляж портирован и оба трансвектора на
него переведены (1.1.13.0) — п. 3 реестра расхождений закрыт. Следующее беру из
`TT_PORT_QUEUE.md`.

**Состояние модуля:** 49 из 84 объектов каталога, версия 1.1.13.0.
