...
**Что в работе сейчас:** свободные предметы почти закрыты — остался только
левитатор с реле. Дальше KAMI: небесный портал, пробуждённый меч, три фокуса.

**Состояние модуля:** 68 из 79 достижимых объектов, версия 1.1.22.0.
