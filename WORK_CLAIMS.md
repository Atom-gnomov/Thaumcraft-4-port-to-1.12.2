...
**Что в работе сейчас:** система камуфляжа портирована (1.1.12.0); следующим
шагом на неё переводится трансвекторный интерфейс — это закроет п. 3 реестра
расхождений.

**Состояние модуля:** 49 из 84 объектов каталога, версия 1.1.12.0.
