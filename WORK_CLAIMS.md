...
**Что в работе сейчас:** свободен. Газы и пылающие шаровары в 1.1.17.0 —
пробуждённая броня собрана целиком.

**Состояние модуля:** 56 из 84 объектов каталога, версия 1.1.17.0.
