...
**Что в работе сейчас:** свободен — цепочка «нитор → шесть пропитанных огней»
закрыта в 1.1.9.0. Следующее беру из `TT_PORT_QUEUE.md`.

**Состояние модуля:** 46 из 84 объектов каталога, версия 1.1.9.0.
