...
public class RenderPrimalOrb extends Render<Entity> {
    ...
    public void doRender(Entity entity, double x, double y, double z, float entityYaw, float partialTicks) {
        renderPrimalSpikes(entity, x, y, z);
        renderPrimalBillboard(entity, x, y, z);
        super.doRender(entity, x, y, z, entityYaw, partialTicks);
    }

    private void renderPrimalSpikes(Entity entity, double x, double y, double z) {
        ...
        for (int i = 0; i < 12; ++i) {
            ...
            int inner = 0xFFFFFF;
            int outer = BlockCustomOreItem.colors[i / 2 + 1];
    ...
    private void renderPrimalBillboard(Entity entity, double x, double y, double z) {
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder buffer = tessellator.getBuffer();
