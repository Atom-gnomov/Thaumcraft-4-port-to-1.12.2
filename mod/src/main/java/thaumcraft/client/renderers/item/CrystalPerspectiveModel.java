...
public final class CrystalPerspectiveModel implements IBakedModel {

    private final IBakedModel delegate;

    public CrystalPerspectiveModel(IBakedModel delegate) {
    ...
    public Pair<? extends IBakedModel, Matrix4f> handlePerspective(ItemCameraTransforms.TransformType cameraTransformType) {
        ItemCrystalRenderer.setTransformType(cameraTransformType);
