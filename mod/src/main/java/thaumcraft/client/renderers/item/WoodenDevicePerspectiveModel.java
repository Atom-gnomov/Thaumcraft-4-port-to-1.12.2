...
public final class WoodenDevicePerspectiveModel implements IBakedModel {

    private final IBakedModel delegate;

    public WoodenDevicePerspectiveModel(IBakedModel delegate) {
    ...
    public Pair<? extends IBakedModel, Matrix4f> handlePerspective(ItemCameraTransforms.TransformType cameraTransformType) {
        ItemWoodenDeviceRenderer.setTransformType(cameraTransformType);
