...
extends ModelBase {
    ...
    public ModelEldritchGuardian() {
        ...
        this.HoodEye = new ModelRenderer((ModelBase)this, 0, 0);
        ...
        this.Hood1 = new ModelRenderer((ModelBase)this, 40, 12);
        ...
        this.Hood2 = new ModelRenderer((ModelBase)this, 36, 28);
        ...
        this.Hood3 = new ModelRenderer((ModelBase)this, 22, 19);
        ...
        this.Hood4 = new ModelRenderer((ModelBase)this, 40, 4);
        ...
        this.ShoulderplateTopR = new ModelRenderer((ModelBase)this, 110, 37);
        ...
        this.ArmL1 = new ModelRenderer((ModelBase)this, 72, 8);
        ...
        this.ArmL2 = new ModelRenderer((ModelBase)this, 76, 28);
        this.ArmL2.addBox(-1.0f, 9.5f, 3.5f, 4, 3, 3);
        this.ArmL2.setTextureSize(128, 64);
        this.ArmL2.mirror = true;
        this.ArmL3 = new ModelRenderer((ModelBase)this, 76, 23);
        ...
        this.ArmR1 = new ModelRenderer((ModelBase)this, 72, 8);
        ...
        this.ArmR2 = new ModelRenderer((ModelBase)this, 76, 28);
        this.ArmR2.addBox(-3.0f, 9.5f, 3.5f, 4, 3, 3);
        this.ArmR2.setTextureSize(128, 64);
        this.ArmR2.mirror = true;
        this.ArmR3 = new ModelRenderer((ModelBase)this, 76, 23);
        ...
        this.SidepanelR2 = new ModelRenderer((ModelBase)this, 0, 54);
        ...
        this.SidepanelR3 = new ModelRenderer((ModelBase)this, 0, 35);
        ...
        this.SidepanelR4 = new ModelRenderer((ModelBase)this, 24, 35);
        ...
        this.SidepanelL2 = new ModelRenderer((ModelBase)this, 0, 54);
        ...
        this.SidepanelL3 = new ModelRenderer((ModelBase)this, 0, 35);
        ...
        this.SidepanelL4 = new ModelRenderer((ModelBase)this, 24, 35);
        ...
        this.LegpanelC1 = new ModelRenderer((ModelBase)this, 16, 45);
        ...
        this.LegpanelC2 = new ModelRenderer((ModelBase)this, 16, 54);
        ...
        this.LegpanelC3 = new ModelRenderer((ModelBase)this, 32, 59);
        ...
        this.Cloak1 = new ModelRenderer((ModelBase)this, 106, 0);
        ...
        this.Cloak2 = new ModelRenderer((ModelBase)this, 106, 19);
        ...
        this.Cloak3 = new ModelRenderer((ModelBase)this, 106, 24);
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        if (entity instanceof EntityEldritchWarden) {
            ...
            int j = (int)(195.0f + MathHelper.sin((float)((float)entity.ticksExisted / 3.0f)) * 15.0f + 15.0f);
            int k = j % 65536;
            int l = j / 65536;
    ...
    public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity) {
        ...
        this.HoodEye.rotateAngleX = this.Hood1.rotateAngleX = par5 / 57.295776f;
        ...
        this.ArmL1.rotateAngleX = -1.0f - all + MathHelper.sin((float)(((float)(entity.ticksExisted + 20) + this.partialTicks) / 10.0f)) * 0.08f;
        this.ArmR1.rotateAngleX = -1.0f - alr + MathHelper.sin((float)(((float)entity.ticksExisted + this.partialTicks) / 10.0f)) * 0.08f;
        this.LegpanelC1.rotateAngleX = -0.15f + MathHelper.sin((float)(((float)entity.ticksExisted + this.partialTicks) / 8.0f)) * 0.12f;
        this.LegpanelC2.rotateAngleX = MathHelper.sin((float)(((float)entity.ticksExisted + this.partialTicks - 5.0f) / 8.0f)) * 0.13f;
        this.LegpanelC3.rotateAngleX = MathHelper.sin((float)(((float)entity.ticksExisted + this.partialTicks - 10.0f) / 8.0f)) * 0.14f;
        this.Cloak1.rotateAngleX = 0.2f + MathHelper.sin((float)(((float)entity.ticksExisted + this.partialTicks) / 7.0f)) * 0.08f;
        this.Cloak2.rotateAngleX = MathHelper.sin((float)(((float)entity.ticksExisted + this.partialTicks - 5.0f) / 7.0f)) * 0.1f;
        this.Cloak3.rotateAngleX = MathHelper.sin((float)(((float)entity.ticksExisted + this.partialTicks - 10.0f) / 7.0f)) * 0.12f;
        this.SidepanelL2.rotateAngleZ = -0.2f + MathHelper.sin((float)(((float)(entity.ticksExisted + 10) + this.partialTicks) / 8.0f)) * 0.12f;
        this.SidepanelL3.rotateAngleZ = MathHelper.sin((float)(((float)entity.ticksExisted + this.partialTicks + 5.0f) / 8.0f)) * 0.13f;
        this.SidepanelL4.rotateAngleZ = MathHelper.sin((float)(((float)entity.ticksExisted + this.partialTicks) / 8.0f)) * 0.14f;
        this.SidepanelR2.rotateAngleZ = 0.2f + MathHelper.sin((float)(((float)(entity.ticksExisted - 5) + this.partialTicks) / 8.0f)) * 0.12f;
        this.SidepanelR3.rotateAngleZ = MathHelper.sin((float)(((float)entity.ticksExisted + this.partialTicks - 10.0f) / 8.0f)) * 0.13f;
        this.SidepanelR4.rotateAngleZ = MathHelper.sin((float)(((float)entity.ticksExisted + this.partialTicks - 15.0f) / 8.0f)) * 0.14f;
    }
