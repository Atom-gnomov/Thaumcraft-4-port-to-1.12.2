...
public abstract class BlockCosmeticStoneSlab extends BlockSlab {

    public static final PropertyEnum<Type> VARIANT = PropertyEnum.create("variant", Type.class);
    public static final PropertyBool SEAMLESS = PropertyBool.create("seamless");

    protected BlockCosmeticStoneSlab() {
        super(Material.ROCK);
        IBlockState state = this.blockState.getBaseState().withProperty(VARIANT, Type.ARCANE);
        if (this.isDouble()) {
    ...
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
        return new ItemStack(ConfigBlocks.blockSlabStone, 1, state.getValue(VARIANT).getMeta());
    }
    ...
    public static final class Half extends BlockCosmeticStoneSlab {
        @Override
    ...
    public static final class Double extends BlockCosmeticStoneSlab {
        @Override
        public boolean isDouble() {
            return true;
        }
