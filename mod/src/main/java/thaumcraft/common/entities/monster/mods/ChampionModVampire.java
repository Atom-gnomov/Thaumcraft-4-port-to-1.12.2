...
public class ChampionModVampire extends java.lang.Object implements IChampionModifierEffect {
    ...
    public void showFX(EntityLivingBase boss) {
        if (boss.world.rand.nextFloat() > 0.2f) return;
        ...
        Thaumcraft.proxy.drawGenericParticles(
                ...
                0.0, 0.0, 0.0,
                0.9f + boss.world.rand.nextFloat() * 0.1f, 0.0f, 0.0f, 0.9f,
                false, 147, 4, 1, 8 + boss.world.rand.nextInt(4), 0, 0.5f + boss.world.rand.nextFloat() * 0.2f
        );
    }
}
