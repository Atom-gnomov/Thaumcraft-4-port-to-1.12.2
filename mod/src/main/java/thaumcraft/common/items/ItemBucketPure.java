...
public class ItemBucketPure extends Item {
    ...
    public boolean tryPlaceContainedLiquid(World world, BlockPos pos) {
        ...
        IBlockState pure = ConfigBlocks.blockFluidPure.getDefaultState()
                .withProperty(BlockFluidBase.LEVEL, BlockFluidPure.SOURCE_LEVEL);
        world.setBlockState(pos, pure, 3);
        return true;
    }
}
